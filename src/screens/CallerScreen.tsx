...
type CallerScreenRouteProp = RouteProp<{ CallerScreen: CallerScreenRouteParams }, 'CallerScreen'>;
...
const ActionButton: FC<{
    ...
    return (
        <TouchableOpacity onPress={onPress} className='items-center space-y-1'>
            <View className='rounded-xl border-border border-2 p-4'>{icon}</View>
...
const CallerScreen: FC = () => {
    ...
    return (
        <CustomSafeAreaView>
            <View className='flex-row mt-2 item-center justify-between px-2'>
                ...
                <Text className='font-medium text-gray-400 text-xss'>IDENTIFIED BY TRUECALLER</Text>
            ...
            <ScrollView style={{ flex: 1 }}>
                <View className='items-center m-4'>
                        ...
                        <ActionButton
                            onPress={async () => {
                                try {
                                    ...
                                    console.log(`Action Button report spam error: `, error);
                                }
                            }}
                    ...
                    <View className='rounded-xl w-full my-2 border-border border-2 p-4'>
                        ...
                        <Text className='text-text text-base font-normal'>California, San Diago</Text>
                    </View>

                    <Text className='font-semibold text-md text-center my-2 text-teal-500'>ADVERTISEMENT</Text>
